...
graph TD
    ...
    AI -->|Cloud Fallback| Groq[Groq API]
```
...
- **Enterprise Privacy Mode**: Instantly skips Gemini calls to route all processes to Groq (`llama-3.3-70b-versatile`).
...
- A [Groq API Key](https://console.groq.com/) for fallback queries.
...
9. **Inspect Security**: Go to **🔒 Security Center**, enable **Enterprise Privacy Mode** to see Gemini bypass routing to Groq.
